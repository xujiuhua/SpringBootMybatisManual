...
public class UserService {
    ...
    public PageView findByPage(PageView pageView) {
        List<User> list = userDao.findByPage(pageView);
        pageView.setRecords(list);
        return pageView;
    }

    public PageView findByPasswordPage(PageView pageView, User user) {
        List<User> list = userDao.findByPasswordPage(pageView, user);
        pageView.setRecords(list);
        return pageView;
    }
}
